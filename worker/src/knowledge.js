...
SELECTED PROJECTS
- Portfolio Concierge — Live AI Demo (Public · on this site): Ask AI text/voice grounded in portfolio facts; React UI + Cloudflare Worker + Workers AI (Llama chat + Whisper STT for Firefox/mobile); origin allowlist, chat/STT rate limits, short-audio caps, daily free-neuron kill-switch. Live: https://wick19.github.io/web-portfolio/
